        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
                onPressed: () async {
                  if (modif == false) {
                    await addStudent(Student(selectedDate.toString(),
                        nomCtrl.text, prenomCtrl.text));
                    widget.notifyParent!();
                  } else {
                    await updateStudent(Student(selectedDate.toString(),
                        nomCtrl.text, prenomCtrl.text, idStudent));
                    widget.notifyParent!();
                  }
                },
